...
public class GraphemeToPhonemeMapperLithuanianImpl {
	 ...
	 * @return
	 */
	public Map<String, List<String>> transform(Iterable<String> words) {
		Map<String, List<String>> rtnWords = new LinkedHashMap<String, List<String>>();
		for (String word : words) {
			rtnWords.put(word, transform(word));
		}
		return rtnWords;
